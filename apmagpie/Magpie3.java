...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
        ...
        else if (findKeyword(statement, "JROTC") >= 0)
        {
            response = "You’re in JROTC? You must be the coolest person ever.";
        }
        else if (findKeyword(statement, "Phone") >= 0)
        {
            response = "What kind of phone do you have?";
        }
        else if (findKeyword(statement, "School") >= 0)
        {
            response = "Which school do you go to?";
        }
		else
		{
